...
namespace wardrobe.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomsID,BottomsName,BottomsColor,BottomsOccasion,BottomsSeason,BottomsPhoto")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,BottomsName,BottomsColor,BottomsOccasion,BottomsSeason,BottomsPhoto")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
