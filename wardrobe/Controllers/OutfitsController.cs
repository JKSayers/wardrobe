...
namespace wardrobe.Controllers
{
    public class OutfitsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OutfitID,TopsID,BottomsID,ShoesID,AccessoryID")] Outfit outfit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OutfitID,TopsID,BottomsID,ShoesID,AccessoryID")] Outfit outfit)
        {
            if (ModelState.IsValid)
            {
